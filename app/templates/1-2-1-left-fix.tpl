...
<body class="twoColFixLtHdr lang-{Application::$language['code']} {$bodyclass}">
	{block::adminBar()}
	<!-- #loader -->
	<div id="loader"><img src="{basePath()}images/loading.gif" alt="" width="32" height="32" /></div>
	<!--/#loader -->
	<div id="body-inner">
		<div id="container">
