...
class Simpleseo implements IContentModule
{
    ...
    {
        include_once(dirname(__FILE__) . '/models/SimpleseoModel.php');
    ...
    function handleShow($id)
    {
        ...
        $allowed = Application::getPermisionForAction(Application::$logged['role'], 'simpleseo', 'view');
    ...
    {
        $allowed = Application::getPermisionForAction(Application::$logged['role'], 'simpleseo', 'edit');
    ...
    {
        if(!Application::getPermisionForAction(Application::$logged['role'], 'simpleseo', 'add')) {
            return '';
        }
		// backward compatibility
		if(!empty ($values) ) {
