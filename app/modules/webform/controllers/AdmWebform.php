<?php
class AdmWebform extends Controller
{
  ...
  function actionSavenew()
  {
	...
	if(Form::$isvalid){
	  ...
	  if($result){
	    redirect('webform/admin', WF_SAVE_NEW_FORM_SAVED);
	  }
	  else{
  ...
  function actionSaveSettings()
  {
	...
	if(Form::$isvalid){
	  ...
	  if($result){
	    redirect('webform/settings', 'Nastavenia boli uložené.');
	  }
	  else{
  ...
  function actionDelete($id)
  {
	...
	if(Application::$delete){
	  ...
	  if($result){
	    redirect('webform/admin', DELETED);
	  }
	  else{
	    redirect('webform/admin', DELETE_FAILED);
	  }
	}
	else{
  ...
  function actionAddField()
  {
    ...
    if(Form::$isvalid){
	  ...
	  if($result){
	    redirect('webform/fields/'.$_POST['webform_id'], 'Nové pole bolo pridané.');
	  }
	  else{
  ...
  function actionOrderFields()
  {
	...
	if($result){
	  redirect('webform/fields/'.$_POST['contid'], WF_ACTION_ORDER_FIELDS_OK);
	}
	else{
  ...
  private function createSettingsForm()
  {
	...
	$form = new Form('wf-settings', 'frm-wf-settings', BASEPATH.'/webform/saveSettings');
  ...
  private function createAddForm()
  {
    ...
    $form = new Form('add-form', 'wf-add-form', BASEPATH.'/webform/savenew');
  ...
  private function createEditForm($id)
  {
    ...
    $form = new Form('wf-editform', 'wf-editform', BASEPATH.'/webform/save');
  ...
  {
    $form = new Form('webform-'.$id, 'web-form', BASEPATH.'/webform/send');
  ...
  private function createAddFieldForm($id)
  {
	...
	$form = new Form('newField', 'new-field-frm', BASEPATH.'/webform/addField/');
  ...
  private function createEditFieldForm($values)
  {
	...
	$form = new Form('edit-field', 'frm-edit-field', BASEPATH.'/webform/savefield');
