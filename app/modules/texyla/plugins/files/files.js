...
jQuery.texyla.setDefaults({
	filesPath: "%texyla_base%/../files",
	filesThumbPath: '%var%',
	filesIconPath: "%texyla_base%/plugins/files/icons/%var%.png",
	filesUploadPath: "%texyla_base%/../files",
	filesMkDirPath: "%texyla_base%/../files",
	filesRenamePath: "%texyla_base%/../files",
	filesDeletePath: "%texyla_base%/../files",
